...
/**
 * Patch the workspace settings document and stamp updatedAt.
 * Creates the document when the workspace has none yet (a patch on a missing
 * local doc is a silent no-op).
 */
