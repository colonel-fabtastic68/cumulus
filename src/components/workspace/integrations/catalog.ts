...
export const INTEGRATIONS: IntegrationDef[] = [
  {
    ...
    settings: [
      ...
      { key: "pushProducts", label: "Push new items to Shopify", help: "Active items that Shopify does not have yet are created there as draft products on every sync, ready to publish.", default: false },
  ...
  },
  {
    ...
    settings: [
      ...
      { key: "pushProducts", label: "Push new items to WooCommerce", help: "Active items that WooCommerce does not have yet are created there as draft products on every sync, ready to publish.", default: false },
