...
export const INTEGRATIONS: IntegrationDef[] = [
  {
    ...
    settings: [
      ...
      { key: "publishProducts", label: "Publish pushed items right away", help: "Off: new products arrive as drafts for you to check first. On: they go live with the price and stock from cumulusOS.", default: false },
