...
/** Opens Strato panel and sends the given prompt straight away. */
export function AskAgentButton({ prompt, label = "Ask Strato", size = "sm", disabled }: { prompt: string; label?: string; size?: "sm" | "md"; disabled?: boolean }) {
  const { open } = useAgent();
  return (
